...
# Initialize an empty list to store the basis functions
spydoy_qaic <- list()
spydoy_rmse <- list()
...
# QAIC for argvar (fun, df) for meteo 
```{r}
...
# Initialize an empty list to store the Q-AIC values
argvar_dfs_qaic <- list()
for (var in vars) {
  # Loop through each combination
  argvar_dfs_qaic[[var]] <- list()
  # Create a linear crossbasis object
...
for (var in vars) {
  ...
  # Create a strata crossbasis object
...
# SAVE LAG, ARGLAG AND ARGVAR IN CSV
```{r}
# Unlist the lists
